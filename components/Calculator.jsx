    ...
    return (
        <div className=' flex flex-col mx-auto max-w-md bg-gray-300/50 sm:rounded-2xl my-5'>
            ...
            <div className="flex justify-between px-4 mt-3">
                ...
                <Button text="/" name="/" className='bg-gray-400 text-black' onClick={handleOnclick} />
                <Button text="*" name="*" className='bg-gray-400 text-black' onClick={handleOnclick} />
                <Button text="X" name="X" className='bg-gray-400 text-black' onClick={handleOnclick} />
            </div>
            <div className="flex justify-between px-4 mt-3">
                <Button text="7" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="8" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="9" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="-" className='bg-gray-400 text-black' onClick={handleOnclick} />
            </div>
            <div className="flex justify-between px-4 mt-3">
                <Button text="4" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="5" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="6" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="+" className='bg-gray-400 text-black' onClick={handleOnclick} />
            </div>
            <div className="flex justify-between px-4 mt-3">
            ...
            <div className="flex justify-between px-4 mt-3">
                ...
                <Button text="0" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text=")" className='bg-green-600 text-black' onClick={handleOnclick} />
                <Button text="=" className='bg-gray-400 text-black' onClick={handleOnclick} />
            </div>
        </div>
